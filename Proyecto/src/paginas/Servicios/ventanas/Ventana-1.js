...
function Ventana1(){
    return(
       <>
       <header className="head11">
        <h1>DISEÑO Y PROGRAMACIÓN DE PÁGINAS WEB</h1>
        <h3 className="h31">Nececitas una página web estructurada, bien diseñada,
        con un codigo impecable y emfocado en el crecimientro, aqui encontraras todo lo que necesitas
        </h3>
    </header>
    <div class="div-11">
    <p class="p-1">¿qué es una página web?</p><br/><br/>
