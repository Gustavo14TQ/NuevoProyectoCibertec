       ...
       <section>
            <div className="images-blog">
                <div className="image-1-blog image-blog">            
                    ...
                    <p style={{
                    color: "black"
                }}>Contenido generado por IA y SEO, Ventajas, desafíos y estrategias</p>
                </div>
                <div className="image-2-blog image-blog">
                    ...
                    <p style={{
                    color: "black"
                }}>AI SEO: Descubre el poder de la Inteligencia Artificial en la optimización SEO</p>
                </div>
                <div className="image-3-blog image-blog">
                    ...
                    <p style={{
                    color: "black"
                }}>Experto de páginas WordPress <br />¿Cómo elegir al mejor para mi proyecto de internet?</p>
                </div>
                <div className="image-4-blog image-blog">
                    ...
                    <p style={{
                    color: "black"
                }}>Entra al mundo del Diseño Web y descubre tu futura página</p>
                </div>
            </div>
                ...
                <div className="sub-form-blog">
                    ...
                    <form >
                        ...
                        <input 
                            ...
                            <p style={{
                    color: "black"
                }}>Deseo recibir la Newsletter y acepto su <u>política y privacidad</u></p><br></br><br></br>
                            <br></br>
                            <button>Enviar</button>
                        </div>

                    </form>
                    <p className="books-blog" style={{
                    color: "black"
                }}>¡Nuestros Ebooks gratis!</p>
                    <p className="qwe-blog" style={{
                    color: "black"
                }}>Stop¡ 40 preguntas antes de contratar un diseño web</p>
